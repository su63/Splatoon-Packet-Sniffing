...
public class GraphicsOut extends Application {
    ...
    @Override public void start(Stage primaryStage) {
    	...
    	holder.pos = holder.p.get(0).time-500+35000;
    ...
    private void drawShapes(GraphicsContext gc) {
    	...
    	for(int i = 0,po = 12;i<holder.t.size();i++){
    		...
    		int x = (Integer.parseInt(vp.substring(4,6)+vp.substring(2,4),16)+0x8000)%0x10000;
    		int y = (Integer.parseInt(vp.substring(10,12)+vp.substring(8,10),16)+0x8000)%0x10000;
    		int z = (Integer.parseInt(vp.substring(16,18)+vp.substring(14,16),16)+0x8000)%0x10000;
    		gc.fillText(vp, 10, po);
    		System.out.println(x+", "+y+", "+z);
    		gc.fillOval((((x-2300)/32)%512), (((z-23000)/32)%512), 5, 5);
    		po+=24;
    	}
    }
